...
- (void)buildUI {
    ...
    gifContainer.layer.cornerRadius = 61.0;
    gifContainer.layer.cornerCurve = kCACornerCurveContinuous;
    ...
    self.gifCurrentView.contentMode = UIViewContentModeScaleAspectFill;
    ...
    self.gifNextView.contentMode = UIViewContentModeScaleAspectFill;
    self.gifNextView.alpha = 0.0;
    ...
    subtitle.font = [UIFont systemFontOfSize:14.5 weight:UIFontWeightRegular];
    ...
    self.keyField.font = [UIFont systemFontOfSize:15.5 weight:UIFontWeightRegular];
    ...
    self.detectButton.titleLabel.font = [UIFont systemFontOfSize:14.5 weight:UIFontWeightSemibold];
    ...
    self.enterButton.titleLabel.font = [UIFont systemFontOfSize:15.5 weight:UIFontWeightBold];
    ...
    NSLayoutConstraint *responsiveWidth =
        [content.widthAnchor constraintEqualToAnchor:root.widthAnchor multiplier:0.80];
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [content.centerYAnchor constraintEqualToAnchor:root.centerYAnchor constant:-112.0],
        ...
        [content.widthAnchor constraintLessThanOrEqualToConstant:326.0],
        responsiveWidth,
        ...
        [gifContainer.widthAnchor constraintEqualToConstant:122.0],
        [gifContainer.heightAnchor constraintEqualToConstant:122.0],
        ...
        [keyBox.topAnchor constraintEqualToAnchor:subtitle.bottomAnchor constant:20.0],
        ...
        [keyBox.heightAnchor constraintEqualToConstant:56.0],

        [self.keyField.leadingAnchor constraintEqualToAnchor:keyBox.leadingAnchor constant:16.0],
        ...
        [hwidBox.topAnchor constraintEqualToAnchor:keyBox.bottomAnchor constant:12.0],
        [hwidBox.leadingAnchor constraintEqualToAnchor:content.leadingAnchor],
        [hwidBox.heightAnchor constraintEqualToConstant:52.0],
        ...
        [self.detectButton.widthAnchor constraintEqualToConstant:92.0],
        ...
        [self.enterButton.topAnchor constraintEqualToAnchor:hwidBox.bottomAnchor constant:16.0],
        ...
        [self.enterButton.heightAnchor constraintEqualToConstant:58.0],
...
- (void)start {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        // Visualmente, os campos ficam vazios ate o usuario interagir novamente.
